...
├── suicidalidad_jovenes_anonimizado.csv # ✅ Dataset SIMULADO (seguro para compartir)
├── codigo_eda_completo.py # Código del análisis demostrativo
│
└── figuras/ # Visualizaciones ilustrativas
